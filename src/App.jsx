// BidDeed.AI Landing Page V15.1.0 - Clean & Sharp Edition
// Built by Ariel Shapira - Developer, Builder & Solo Founder
...
// Hero Section
const Hero = () => (
  <section className="pt-24 pb-16 sm:pt-32 sm:pb-24 px-4 sm:px-6 lg:px-8 bg-slate-900">
  ...
  <section id="founder" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-slate-900">
    <div className="max-w-4xl mx-auto">
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="bg-slate-800 rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-12 border border-slate-700"
      >
        <div className="text-center">
          ...
          <div className="text-slate-400 text-sm sm:text-base">Developer & Builder • Solo Founder of BidDeed.AI</div>
...
const Waitlist = () => {
  ...
  return (
    <section id="waitlist" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-slate-800">
